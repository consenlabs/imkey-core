...
class BTCViewController: UIViewController {
  ...
  @IBAction func btcAddrBtnClick(_ sender: Any) {
    do {
      txtResult.text = ""
      let address = try BtcApi.getAddress(network: BtcApi.network_mainet, path: BIP44.btcMainnet)
      Log.d(address)
  ...
  @IBAction func btcSegwitAddrClick(_ sender: Any) {
    do {
      ...
      let segwitAddr = try BtcApi.getSegwitAddress(network: BtcApi.network_mainet, path: segwitPath)
      Log.d(segwitAddr)
  ...
  @IBAction func btcRegAddr(_ sender: Any) {
    do {
      ...
      let address = try BtcApi.displayAddress(network: BtcApi.network_mainet, path: path)
  ...
  @IBAction func btcRegSegwitAddr(_ sender: Any) {
    do {
      ...
      let address = try BtcApi.displaySegwitAddress(network: BtcApi.network_mainet, path: path)
