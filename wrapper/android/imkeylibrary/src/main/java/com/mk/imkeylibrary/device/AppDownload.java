...
public class AppDownload extends TsmRequest {
    ...
    public AppDownloadResponse download(AppDownloadRequest request) {
        if (request == null)
        ...
        AppDownloadResponse response = fromJson(res);
        ...
        if (response.get_ReturnCode().equals("000000")) {
            ...
            if (returnDataBean != null) {
                if ("end".equals(returnDataBean.getNextStepKey())) {
                    ...
                    AppDownloadRequest reRequest = new AppDownloadRequest();
    ...
    private String toJson(AppDownloadRequest request) {
    ...
    private AppDownloadResponse fromJson(String json) {
