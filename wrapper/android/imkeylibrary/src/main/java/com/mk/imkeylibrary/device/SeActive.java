...
public class SeActive extends TsmRequest {
    ...
    public SeActivateResponse activeSe(SeActivateRequest request) {
        if (request == null)
        ...
        SeActivateResponse response = fromJson(res);
        ...
        if (response.get_ReturnCode().equals("000000")) {
            ...
            if (returnDataBean != null) {
                if ("end".equals(returnDataBean.getNextStepKey())) {
                    ...
                    SeActivateRequest reRequest = new SeActivateRequest();
    ...
    private String toJson(SeActivateRequest request) {
    ...
    private SeActivateResponse fromJson(String json) {
        SeActivateResponse response = new SeActivateResponse();
        try {
