...
//        }
    ...
    public static TransactionSignedResult testCosmosTxSign() {
        ...
        try {
            ...
            Cosmos.CosmosTxInput cosmosTxInput = Cosmos.CosmosTxInput.newBuilder()
                    .setData("")
                    .build();
            Any inputAny = Any.newBuilder()
                    .setValue(cosmosTxInput.toByteString())
                    .build();

            Common.SignParam signData = Common.SignParam.newBuilder()
                    .setChainType("COSMOS")
                    .setInput(inputAny)
                    .setPath(Path.COSMOS_LEDGER)
                    .setPayment("0.001 ATOM")
                    .setReceiver("cosmos1yeckxz7tapz34kjwnjxvmxzurerquhtrmxmuxt")
                    .setSender("cosmos1ajz9y0x3wekez7tz2td2j6l2dftn28v26dd992")
                    .setFee("0.00075 atom")
                    .build();

            Any signParamAny = Any.newBuilder()
                    .setValue(signData.toByteString())
                    .build();
            ...
            if(!"".equals(error) && null != error) {
                ...
                Cosmos.CosmosTxOutput response = Cosmos.CosmosTxOutput.parseFrom(ByteUtil.hexStringToByteArray(result));
                String signature = response.getSignature();
                LogUtil.d("××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××");
                LogUtil.d("signature：" + signature);
                LogUtil.d("××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××");

                txSignResult = new TransactionSignedResult(signature, "");
            }
        } catch (Exception e) {
