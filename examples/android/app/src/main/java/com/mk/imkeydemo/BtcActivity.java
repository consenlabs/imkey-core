...
import com.mk.imkeydemo.keycore.Btc;
...
public class BtcActivity extends AppCompatActivity {
    ...
    private void btcAddress(){
        es.execute(new Runnable() {
            ...
            public void run() {
            try {
                String address = new Btc().getAddress(0, "m/44'/0'/0'/0/0");
    ...
    private void btcSegwitAddress(){
        es.execute(new Runnable() {
            ...
            public void run() {
            try {
                String address = new Btc().getSegWitAddress(5, "m/49'/0'/0'/0/22");
                showResult(address);
            } catch (Exception e) {
                showResult(e.getMessage());
            }
    ...
    private void btcRegAddress(){
        es.execute(new Runnable() {
            ...
            public void run() {
            try {
                String address = new Btc().displayAddress(0, "m/44'/0'/0'/0/0");
                showResult(address);
            } catch (Exception e) {
                showResult(e.getMessage());
            }
    ...
    private void btcRegSegwitAddress(){
        es.execute(new Runnable() {
            ...
            public void run() {
            try {
                String address = new Btc().displaySegWitAddress(5, "m/49'/0'/0'/0/0");
                showResult(address);
            } catch (Exception e) {
                showResult(e.getMessage());
            }
