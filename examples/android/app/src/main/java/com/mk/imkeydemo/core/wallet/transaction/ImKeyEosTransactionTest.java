...
*/
    ...
    public static List<TxMultiSignResult> testEosTxSign() {
        ...
        try {
            eosapi.Eos.EosSignData data = eosapi.Eos.EosSignData.newBuilder()
                    .setTxHex("c578065b93aec6a7c811000000000100a6823403ea3055000000572d3ccdcd01000000602a48b37400000000a8ed323225000000602a48b374208410425c95b1ca80969800000000000453595300000000046d656d6f00")
                    .setChainId("aca376f206b8fc25a6ed44dbdc66547c36c6c33e3a119ffbeaef943642f0e906")
                    .setReceiver("bbbb5555bbbb")
                    .setSender("liujianmin12")
                    .setPayment("undelegatebw 0.0100 EOS")
                    .addPublicKeys("EOS88XhiiP7Cu5TmAUJqHbyuhyYgd6sei68AU266PyetDDAtjmYWF")
                    .build();

            Eos.EosTxInput eosTxReq = Eos.EosTxInput.newBuilder()
            ...
            if(!"".equals(error) && null != error) {
                ...
                Eos.EosTxOutput response = Eos.EosTxOutput.parseFrom(ByteUtil.hexStringToByteArray(result));
                Eos.EosSignResult signResult = response.getTransMultiSigns(0);
                String signature = signResult.getSigns(0);
                String hash = signResult.getHash();
                List signs = signResult.getSignsList();
                LogUtil.d("××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××");
                LogUtil.d("hash：" + hash);
                LogUtil.d("signs：" + signature);
                LogUtil.d("××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××");
    ...
    public static String testEosMsgSign() {
        ...
        try {
            ...
            Eos.EosMessageInput eosMessageSignReq = Eos.EosMessageInput.newBuilder()
                    .setData("imKey2019")
                    .setIsHex(false)
                    .setPubkey("EOS88XhiiP7Cu5TmAUJqHbyuhyYgd6sei68AU266PyetDDAtjmYWF")
                    .build();
            ...
            if(!"".equals(error) && null != error) {
                ...
                Eos.EosMessageOutput response = Eos.EosMessageOutput.parseFrom(ByteUtil.hexStringToByteArray(result));
