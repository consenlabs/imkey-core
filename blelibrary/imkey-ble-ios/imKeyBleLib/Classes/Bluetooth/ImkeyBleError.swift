...
public protocol ImkeyBleError: Error {
  var message: String { get }
}

public protocol ImkeyBleDescError: ImkeyBleError { }

public protocol ImkeyBleCodeError: ImkeyBleError { }

public extension ImkeyBleDescError where Self: RawRepresentable, Self.RawValue == String {
  var message: String {
    return rawValue
  }
}

public enum BleSDKError: String, ImkeyBleDescError {
...
public enum BleDeviceError: Int64, ImkeyBleCodeError {
  case ok = 0x00000000
...
public enum BleApduError: String, ImkeyBleDescError {
...
//extension String : ImkeyBleError {
//  public var message: String {
//    return self
//  }
//}
